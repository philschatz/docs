/**
 * Distribution panel shown below the formula bar when a cell with
 * Monte Carlo results is selected. Shows a histogram and key statistics.
 */
  ...
  return (
    <div className="dist-panel">
      ...
      <div className="dist-stats">
        <span title="Mean">μ={formatNum(stats.mean)}</span>
